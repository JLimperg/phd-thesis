...
% TODO tool formatting: no special formatting; quotes for confusing names (e.g. "by")
% TODO inline code formatting: use math mode, \tac for tactics
% TODO listings formatting: use \begin{leancode}
