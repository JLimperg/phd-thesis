...
By contrast, \emph{automated theorem provers} (ATPs), including SAT/SMT solvers~\cite{SATHandbook,Z3,CVC5} and superposition-based theorem provers~\cite{Vampire,Zipperposition}, provide \enquote{push-button} automation that seeks to find proofs without any help from users.
...
Meanwhile, Systems based on tactic-level search or decomposition tend to involve large numbers of LLM queries.
