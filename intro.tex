...
As an additional optimisation, we partition the subgoals of a rule into \emph{metavariable clusters}, which are minimal sets of goals transitively coupled by metavariables.
