...
If a goal's target contains an expression of the form \texttt{if t then … else …} or \texttt{match t with …}, then this rule performs a case split on $t$, producing a simpler goal for each possible case.
